...
if __name__ == '__main__':
    ...
    for i in range(1, len(os.listdir('side_1/')) - 2):
        ...
        if y_vector < 0 and abs(y_vector) > threshold:
            ...
            cv2.imwrite('side_1//side_frame(' + str(i) + ').jpg', img1)
            break
