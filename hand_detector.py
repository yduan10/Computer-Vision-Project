...
if __name__ == '__main__':
    ...
    for i in range(1, len(os.listdir('birdview/')) - 1):
        ...
        plt.figure("finger count"+str(k)+"img")
...
# Generate the video
size = (1280,720)
videowrite = cv2.VideoWriter('finger_counts/out.mp4',-1,30,size)
img_array=[]
for filename in ['finger_counts/birdview_frame_with_finger_counts('+ str(i) +').jpg' for i in range(1,112)]:
